...
# -----------------------------------------------------------------------------
# Builder: docker build -t rusty:alpine -f Dockerfile .
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Final image: docker run -it --rm -p 3030:3030 rusty:alpine
# -----------------------------------------------------------------------------
...
# Import from builder.
COPY --from=builder --chown=groot:groot /app/target/x86_64-unknown-linux-musl/release/rusty .
